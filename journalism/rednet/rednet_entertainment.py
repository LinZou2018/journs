...
def starts():
    urls = ["http://ent.rednet.cn/Class/1192.html", "http://ent.rednet.cn/Class/1196.html",
            "http://ent.rednet.cn/Class/1197.html", "http://ent.rednet.cn/Class/2235.html",
            "http://ent.rednet.cn/Class/1198.html", "http://ent.rednet.cn/Class/1484.html",
            ""]
    for i in urls:
        url = i
        response = requests.get(url, headers=headers.header())
